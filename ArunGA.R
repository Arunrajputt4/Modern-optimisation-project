    ...
    runGA <- function(noRuns = 30, problem = "feature", popSize = 15, pmutation = 0.2, pcrossover = 0.2) {
    ...
    results1 <- runGA(noRuns = 30, problem = "feature",  popSize = 20, pcrossover = 0.2, pmutation = 0.2)
    
    # Run with default population size (30)
    results2 <- runGA(noRuns = 30, problem = "feature", popSize = 20, pcrossover = 0.4, pmutation = 0.4)
    
    # Run with a larger population size (50)
    results3 <- runGA(noRuns = 30, problem = "feature",  popSize = 20, pcrossover = 0.6, pmutation = 0.6)